...
import { BookOpen, LogOut, User, MessageCircle } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-16 items-center">
                    <Link to="/" className="flex items-center gap-2 group">
                        ...
                        <span className="text-2xl font-bold bg-gradient-to-r from-[#9B7EBD] to-[#D4A574] bg-clip-text text-transparent">
                            BookSwap
                        </span>
                    </Link>
